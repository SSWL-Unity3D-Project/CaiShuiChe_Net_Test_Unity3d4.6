...
public class FreeModeCtrl : MonoBehaviour
{
	...
	static FreeModeCtrl _Instance;
	public static FreeModeCtrl GetInstance()
	{
		return _Instance;
	}
...
//			}
//
//			NetworkServerNet NetworkServerScript = NetCtrlScript.GetNetworkServerNetScript();
//			if(NetworkServerScript != null && !NetworkServerScript.CheckIsLinkedServerPort())
//			{
//				NetworkServerScript.TryToLinkServer();
//			}
//		}
